...
nbamServiceCtrl.getOffers("7777777779", "RHBShellCard", "Web", "Login", "Home", "Inbound", handleResponse);
...
function handleResponse(data) {
    ...
    for (i = 0; i < data.ContainerList[0].RankedResults.length; ++i) {
        ...
        var compareVariant = "business_loan_approval, bizpower_property_loan, bizpower_relief_financing, rhb_visa_infinite, home_loan_approval, rm_coupons, fuel_up_more, car_loan";
        var contentRight = "";
