function getNBAMServiceControl(serviceClass,callMultiContainer) {
	...
	var serverHostname = "https://decisioning05.areteans.com";
	var serverPort = "";
	...
	var NBAMServiceControl = {
		...
		getServiceURL : function (serviceName,params) {
			...
			{
				url="https://decisioning05.areteans.com/prweb/PRRestService/PegaMKTContainer/V2/Container";
		...
		getOffers : function (CustomerID, containerName, channel, previousPage, currentpage, direction, callback) {
		...
		//alert("2");
			...
			var jsonObj = this.getJSONObj(CustomerID, containerName, channel, previousPage, currentpage, direction);
		...
		getJSONObj : function(CustomerID, containerName, channel, previousPage, currentpage, direction){
			if(serviceClass){				
				var jsonObj = {
